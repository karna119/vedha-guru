...
const teluguTranslations: Translations = {
    ...
    step1Title: 'సమస్య చెప్పండి',
    step1Desc: 'మీ మాటల్లో మీ బాధను వివరించండి.',
    step2Title: 'శాస్త్ర విశ్లేషణ',
    step2Desc: 'గీత, రామాయణం ద్వారా విశ్లేషణ.',
    step3Title: 'ధర్మ మార్గం',
    step3Desc: 'శ్లోకం మరియు పరిష్కారం పొందండి.',
...
const englishTranslations: Translations = {
    ...
    step1Title: 'Speak Your Heart',
    step1Desc: 'Share your dilemma in your own words.',
    step2Title: 'Ancient Wisdom',
    step2Desc: 'AI analyzes via Gita, Ramayana & Puranas.',
    step3Title: 'Clear Guidance',
    step3Desc: 'Get a specific Shloka & practical advice.',
